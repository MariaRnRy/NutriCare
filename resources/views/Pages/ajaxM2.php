            ...
            function formulas1(num)
            {
                ...
                function pesoTeorico(x) {
                    if (x.length == 0) { 
                        ...
                        xmlhttp.open("GET", "/imss/resources/views/Pages/FormulasM/pesoTeo.php?q=" + x, true);
                        xmlhttp.send();
                    }
                }
                ...
                function pesoInferior(x) {
                    if (x.length == 0) { 
                        ...
                        xmlhttp.open("GET", "/imss/resources/views/Pages/FormulasM/pesoInfe.php?q=" + x, true);
                        xmlhttp.send();
                    }
                }
                ...
                function pesoSuperior(x) {
                    if (x.length == 0) { 
                        ...
                        xmlhttp.open("GET", "/imss/resources/views/Pages/FormulasM/pesoSupe.php?q=" + x, true);
                        xmlhttp.send();
                    }
                }
                ...
                function imc(x,y) {
                    if (x.length == 0 || y.length == 0) { 
                        ...
                        xmlhttp.open("GET", "/imss/resources/views/Pages/FormulasM/imc.php?q="+x+"&p="+y, true);
                        xmlhttp.send();
                    }
                }
                ...
                function porcenPH(x,y) {
                    if (x.length == 0 || y.length == 0) { 
                        ...
                        xmlhttp.open("GET", "/imss/resources/views/Pages/FormulasM/PPH.php?q="+x+"&p="+y, true);
                        xmlhttp.send();
                    }
                }
                ...
                function porcenPT(x,y) {
                    if (x.length == 0 || y.length == 0) { 
                        ...
                        xmlhttp.open("GET", "/imss/resources/views/Pages/FormulasM/PPT.php?q="+x+"&p="+y, true);
                        xmlhttp.send();
                    }
                }
                ...
                function PPCI(x,y) {
                    if (x.length == 0 || y.length == 0) { 
                        ...
                        xmlhttp.open("GET", "/imss/resources/views/Pages/FormulasM/ppci.php?q="+x+"&p="+y, true);
                        xmlhttp.send();
                    }
                }
                ...
                function ICC(x,y) {
                    if (x.length == 0 || y.length == 0) { 
                        ...
                        xmlhttp.open("GET", "/imss/resources/views/Pages/FormulasM/ICC.php?q="+x+"&p="+y, true);
                        xmlhttp.send();
                    }
                }
                ...
                function clasificacion(x,y) {
                    if (x.length == 0 || y.length == 0) { 
                        ...
                        xmlhttp.open("GET", "/imss/resources/views/Pages/FormulasM/clasif.php?q="+x+"&p="+y, true);
                        xmlhttp.send();
                    }
                }
                ...
                function PA(x) {
                    if (x.length == 0) { 
                        ...
                        xmlhttp.open("GET", "/imss/resources/views/Pages/FormulasM/PA.php?q="+x, true);
                        xmlhttp.send();
                    }
                }
                ...
                function CM(x,y) {
                    if (x.length == 0 || y.length == 0) { 
                        ...
                        xmlhttp.open("GET", "/imss/resources/views/Pages/FormulasM/circunMu.php?q="+x+"&p="+y, true);
                        xmlhttp.send();
                    }
                }
                function CM(x,y) {
                ...
                function MP(x,y) {
                    if (x.length == 0 || y.length == 0) { 
                        ...
                        xmlhttp.open("GET", "/imss/resources/views/Pages/FormulasM/MP.php?q="+x+"&p="+y, true);
                        xmlhttp.send();
                    }
                }
