            ...
            function formulas1(num)
            {
                ...
                function sum_hc(a,b,c,d,e,f) {
                    if (a.length == 0 || b.length == 0 || c.length == 0 || d.length == 0 || e.length == 0 || f.length == 0) { 
                        ...
                        document.getElementById("hc_graf").innerHTML = "";
                ...
                function sum_prot(a,b,c,d,e) {
                    if (a.length == 0 || b.length == 0 || c.length == 0 || d.length == 0 || e.length == 0) { 
                        ...
                        document.getElementById("prot_graf").innerHTML = "";
                        return;
                    } else {
                        var xmlhttp = new XMLHttpRequest();
                        xmlhttp.onreadystatechange = function() {
                            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                                ...
                                document.getElementById("prot_graf").innerHTML = 4*xmlhttp.responseText;
                            }
                        };
                ...
                function sum_lip(a,b,c,d) {
                    if (a.length == 0 || b.length == 0 || c.length == 0 || d.length == 0) { 
                        ...
                        document.getElementById("lip_graf").innerHTML = "";
                        return;
                    } else {
                        var xmlhttp = new XMLHttpRequest();
                        xmlhttp.onreadystatechange = function() {
                            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                                ...
                                document.getElementById("lip_graf").innerHTML = 9*xmlhttp.responseText;
                            }
                        };
